...
#Region "#CustomPages"
    ...
    Friend Class CustomChooseDataSourceTypePage
        ...
        Public Sub New(ByVal view As IChooseDataSourceTypePageView, ByVal context As IWizardRunnerContext, ByVal dataConnections As IEnumerable(Of SqlDataConnection), ByVal solutionTypesProvider As ISolutionTypesProvider)
            MyBase.New(view, context, dataConnections, solutionTypesProvider)
        End Sub
